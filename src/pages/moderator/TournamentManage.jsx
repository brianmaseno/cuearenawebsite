   ...
   return (
      <DashboardLayout title="Manage Tournament">
         <div className="space-y-8 pb-20">
            ...
            {/* Players & Invite Sidebar - Now ON TOP */}
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
               ...
               <div className="card-premium p-6 rounded-2xl shadow-sm flex flex-col h-fit bg-base3/30 backdrop-blur-md">
                  {/* Search & Invite - Only if not started */}
                  {tournament.status !== 'ongoing' && tournament.status !== 'completed' ? (
                              ...
                              <>
                                 ...
                                 {availablePlayers
                                    ...
                                    .filter(p => 
                                       ...
                                       <p className="text-center py-4 text-xs italic text-text/30 font-bold">No results for "{playerSearchQuery}"</p>
                                 )}
                              </>
                           ) : (
                     ...
                     <div className="text-center py-4 mb-4 border-b border-base2/10">
                        ...
                        <p className="text-xs font-black uppercase tracking-widest text-text-emphasis">Tournament in Progress</p>
                        <p className="text-[10px] font-bold text-text/40 mt-1">Registrations are closed</p>
                     </div>
                  )}

                  {/* Invitation Status Tracking - Always visible if pending invites exist */}
                           ...
                           {invitations
                              ...
                              <div key={inv._id} className="flex items-center justify-between p-2.5 bg-base2/10 rounded-xl border border-base2/30">
                                 <div className="min-w-0 pr-2">
                                    ...
                                    <p className="text-[9px] text-text/40 font-medium">{inv.status === 'pending' ? 'Awaiting response...' : 'Invitation declined'}</p>
                                 </div>
            ...
            {/* Brackets Section - Now BELOW players */}
