                        ...
                        <div className="space-y-4">
                          ...
                          {match.status === 'completed' ? (
                            (() => {
                              ...
                              return (
                                <div className={`w-full py-3 rounded-xl text-sm font-black flex flex-col items-center justify-center gap-1 shadow-sm border ${myWonMatch ? 'bg-green/10 text-green border-green/20' : 'bg-red/10 text-red border-red/20'
                                  }`}>
